export const footerColumnData = [
  {
    title: "CMA Transportes",
    information: [
      {
        subtitle: "Sobre la empresa",
        info:
          "Somos una empresa dedicada al transporte privado y de turismo 24/7. Contamos con una variedad de servicios para diversas necesidades, tanto para empresas, como para las necesidades cotidianas de las personas. Nuestro servicio se caracteriza por brindar seguridad, comodidad y diligencia cuando se trata del transporte de pasajeros para los diversos fines, ya sean laborales o turísticos. Además, contamos con un servicio especial de transporte de encomiendas, en donde se pone énfasis desde el momento de la recepción de la encomienda hasta la entrega, respetando los tiempos estipulados y confirmando la entrega con el cliente.",
      },
      {
